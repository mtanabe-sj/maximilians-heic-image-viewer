...
@set ProductDescription=This setup program installs a Windows Explorer add-on. It lets you preview, display and print HEIC image files from within the Windows Explorer. You need administrator privileges to install.
